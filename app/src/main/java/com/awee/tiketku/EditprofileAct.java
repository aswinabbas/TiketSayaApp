...
public class EditprofileAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_add__new_photo = findViewById(R.id.btn_add__new_photo);
        ...
        btn_add__new_photo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                findPhoto();
            }
    ...
    //function untuk mencari letak foto
